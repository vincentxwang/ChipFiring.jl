...
function main()
    input_filename = "vincent/genus_6_trivalent.txt"
    output_filename = "vincent/genus_6_trivalent_three_subdiv.out"
            ...
            for (i, line) in enumerate(eachline(infile))
                try
                    ...
                    if b != -1
                        ...
                        write(outfile, "first gonality: $a -> $b\n")
                    end
                    ...
                    if d != -1
                        ...
                        write(outfile, "second gonality: $c -> $d\n")
                    end
                    ...
                    #     write(outfile, "$(sprint_graph(g))\n")
                    # else
                    #     write(outfile, "third gonality: $e -> $f\n")
                    # end
